  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#f7f7f4] text-gray-900 px-2 sm:px-4 pt-[70px] md:pt-[80px]">
      ...
      <div className="mb-4 sm:mb-6 md:mb-8 w-full">
        <h1 className="text-[15vw] lg:text-[18vw] font-bold text-center mt-[-40px] lg:mt-[-100px] lg:mb-[-60px] font-audiowide ">SLAVVO.</h1>
      ...
      <div className="flex flex-col md:flex-row w-full md:mb-8 ">
        ...
        <div className="flex flex-col md:justify-normal lg:justify-end w-full md:w-2/4 md:pl-4 pl-2 h-[400px] md:h-[700px] ml-0 lg:ml-4">
          <p className="lg:text-sm text-xs lg:mb-1 font-merriweather tracking-normal leading-loose lg:tracking-wide lg:leading-relaxed sm:tracking-tight sm:leading-normal">
          ...
          <a href="#" className="font-merriweather text-xs lg:text-sm underline hover:bg-black hover:text-white p-1 transition duration-300 flex items-center w-fit ">
      ...
      <hr className="lg:mb-3 mt-28 w-full border-t-4 border-black"/>
      ...
      <div className="flex flex-col md:flex-row w-full mb-6 lg:mb-8 justify-between">
        <div className="flex flex-col justify-center w-full md:w-[50%] lg:pl-32 pr-4 md:h-[500px] h-[600px] ">
          <h2 className="md:text-2xl text-sm md:mb-9 font-bold text-center font-audiowide lg:mt-18 md:mt-0">“SOUL & SOIR” : JAN 16 2025</h2>
          <p style={{ letterSpacing: '0.19em', lineHeight: '1.9' }} className="md:text-base text-xs text-center md:text-left md:mb-2 mb-4 font-merriweather">
